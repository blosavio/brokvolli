...
(deftest kv-transducer-tests
  (are [x y] (= x y)
    ...
    (transduce-kv (mapcat-kv (fn [_ x] (reverse x))) conj [[22 11] [44 33] [66 55]]) [11 22 33 44 55 66]
    ...
    (transduce-kv (take-nth-kv 2) conj [11 22 33 44 55 66]) [11 33 55]
    (transduce-kv (drop-kv 3) conj [11 22 33 44 55]) [44 55]
