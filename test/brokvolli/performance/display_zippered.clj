(ns brokvolli.performance.display-zippered
  ...
  (:require
   ...
   [brokvolli.performance.measure-zip :refer [memory-filename
                                              output-dir
                                              max-length-pow-10
                                              zippered-fns
                                              time-filename]]
...
(def img-dir "doc/img/")
(def memory-chart-filename (str img-dir "zip_memory.svg"))
(def timing-chart-filename (str img-dir "zip_timings.svg"))

(def html-directory "doc/")
(def html-filename "zip_constructors.html")
(def markdown-directory "doc/")
(def markdown-filename "zip_constructors.md")

(def page-title "Memory and timing measurements of various zippers")
(def page-copyright-holder "Brad Losavio")
(def page-uuid #uuid "e378c649-434d-4237-a25d-cbdc0759e798")
...
(defn generate-documents
  ...
  From command line:
  ```bash
  $ lein run -m brokvolli.performance.display-zippered/generate-documents
  ```"
